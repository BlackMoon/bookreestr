...
(function ($, window, document, undefined) {
	...
	var MessageBox = {
		init: function (options) {
			...
			self.content = (typeof options === 'string') ? options : options.content;
		...
		getDialogContent: function () {
			...
			var dialogView = "<div style='height:15px;'></div>";
				...
				dialogView += "<div style='float:left;' id='content'>";
					dialogView += "<p style='padding: 6px 6px 0 20px;'>" + content + "</p>";
				dialogView += "</div>";
	...
	$.showMessageBox.options = {
		...
		type: 'Information',
		imagePath: '/bookreestr/content/images/',
