...
3. После успешного развертывания проект доступен по адресу - /bookreestr
	Смена парметра contextRoot производится в pom.xml .ear-проекта.
...
9. Проект на google - https://code.google.com/p/bookreestr/
